...
import tools.view.AssistTouchViewLayout;
import tools.view.FloatWindowMenuView;
	...
	public static void createSmallWindow(Context context) {
		...
		if (smallWindow == null) {
			...
			if (smallWindowParams == null) {
				...
				smallWindowParams.type = LayoutParams.TYPE_APPLICATION_OVERLAY;//LayoutParams.TYPE_PHONE;
	...
	public static void createBigWindow(Context context) {
		...
		if (bigWindow == null) {
			...
			if (bigWindowParams == null) {
				...
				bigWindowParams.type = LayoutParams.TYPE_APPLICATION_OVERLAY;//LayoutParams.TYPE_PHONE;
	...
	public static void setFullScreen(Context context, boolean enable) {
		if (context instanceof Activity) {
			...
			if (enable) {
				...
				activity.getWindow().clearFlags(LayoutParams.FLAG_FORCE_NOT_FULLSCREEN);
				View decorView = activity.getWindow().getDecorView();
				int uiOptions = View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_FULLSCREEN;
				decorView.setSystemUiVisibility(uiOptions);
			} else {
				activity.getWindow().clearFlags(LayoutParams.FLAG_FULLSCREEN);
				activity.getWindow().addFlags(LayoutParams.FLAG_FORCE_NOT_FULLSCREEN);
				View decorView = activity.getWindow().getDecorView();
